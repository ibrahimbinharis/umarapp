...
function useDashboard(uiData, userSession) {
    ...
    const calculateStats = () => {
        ...
        // 2. Admin/Guru View
            ...
            const filteredPelanggaran = allPelanggaran.filter(d => isMatch(d.created_at)); // Use created_at for pelanggaran date matching
            ...
            santris.forEach(s => {
                ...
                // Global Total Pages for Stats Cards (Keep All Time or switching to Monthly? Keeping All Time for Stats Cards as per usual dashboard behavior, but Leaderboard is Monthly)
                // Actually, the previous implementation of getStudentStats calculated All Time pages.
                // Let's keep tSabaq/tManzil as All Time for the stats cards at the top.
                ...
                leaderboard.push({
                    name: s.full_name,
                    class: s.kelas,
                    total: finalScore, // Using Final Score
                    gender: s.gender,
                    // Helper data if needed for UI
                    sabaq: actualSabaq,
                    manzil: actualManzil
                });
            });
            ...
            dashboardStats.topSantri = leaderboard
