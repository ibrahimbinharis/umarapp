...
// --- HARDCODED CONFIG ---
const HARDCODED_SYNC_URL = "https://script.google.com/macros/s/AKfycby7WELC1LPGpNoyZv1CAx8jYXZxmR95kz10yVQbSAfdzDh_TC2OrUxD1vI0ZftNcfc7Pw/exec";
    ...
    if (cached) {
        ...
        try {
            ...
            if (json.code === 200) {
                ...
                localStorage.setItem('tahfidz_surah_cache', JSON.stringify(surahList));
