...
function renderLayout(activePage, contentHTML) {
    ...
    <div class="flex-1 flex flex-col h-full md:pl-64 bg-slate-50 relative">
        <header class="md:hidden sticky top-0 z-40 bg-white/90 backdrop-blur-md border-b border-slate-200 px-4 h-16 flex items-center justify-between shadow-sm">
        ...
        <main class="flex-1 overflow-y-auto w-full max-w-7xl mx-auto p-4 md:p-8 pb-24 md:pb-8">${contentHTML}</main>
        ${mobileNav}
    </div>
